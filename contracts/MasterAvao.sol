...
contract AvaOne is ERC20("AvaOne", "AVAO"), Ownable {
    ...
    uint256 public maxSupply = 500_000_000e18; // 500 million Avao
...
contract MasterChefAvaoV2 is Ownable {
    ...
    struct UserInfo {
        ...
        uint256 proxyRewardDebt; // Debt over the proxy reward. Same as below.
        //
    ...
    function add(
        ...
        emit Add(poolInfo.length.sub(1), _allocPoint, _lpToken, _proxy);
    }
    ...
    // Get the 24 hour rewards for a given pool.
    function get24HRewardForPool(uint256 _pid) external view returns (uint256 oneDayReward, uint256 oneDayProxyReward) {
